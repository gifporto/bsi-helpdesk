                    ...
                    <tr>
                        ...
                        <td>
                            <div class="media-right">
                                <button
                                    class="btn btn-flat btn-sm btn-bold btn-round btn-warning"><?= $guest['status'] ?></button>
                            </div>
                        </td>
                        <td class="text-center d-flex">
                            <button class="btn btn-round btn-success btn-square text-center"
                                onclick="updateStatus(<?= $guest['id'] ?>, 'Selesai')" title="Selesai"><i
                                    class="fa fa-check"></i></button>
                            <button class="mx-2 btn btn-round btn-warning btn-square text-center" data-toggle="modal"
                                data-target="#modal_pesan_<?= $guest['id'] ?>" title="Pesan"><i
                                    class="fa fa-commenting-o"></i></button>
                            <button class="btn btn-round btn-danger btn-square text-center"
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('super/pelayanan/send_wa'); ?>" method="post">
                <div class="modal-body">
                    <input type="hidden" name="redirect_to" value="super/pelayanan/index_proses">
...
<script>
    ...
    function updateStatus(id, status) {
        $.ajax({
            url: '<?= site_url('super/Pelayanan/update_status') ?>',
            type: 'POST',
            data: {
                id: id,
                status: status
