    ...
    <div class="card shadow-2">
        <div class="card-body">
            <div class="flexbox mb-20">
                ...
                <div class="ml-2">
                    <button class="btn btn-sm btn-round btn-custom"
                        onclick="exportToExcel('table1', 'data_eoffice.xlsx')">Cetak<i
                            class="ml-2 bi bi-printer-fill"></i></button>
                </div>
            </div>
            <table id="table1" class="table table-separated table-striped table-responsive-sm"
