                    ...
                    <?php foreach ($guests as $guest) { ?>
                        <tr>
                            ...
                            <td class="text-center d-flex">
                                ...
                                <button class="btn btn-warning btn-square text-center" data-toggle="modal" data-target="#modal_pesan_<?= $guest['id'] ?>" title="Pesan"><i class="fa fa-commenting-o"></i></button>
