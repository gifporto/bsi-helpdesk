                    ...
                    <?php foreach ($guests as $guest) { ?>
                        <tr>
                            ...
                            <td class="text-center d-flex">
                                ...
                                <button class="mx-2 btn btn-round btn-warning btn-square text-center" data-toggle="modal" data-target="#modal_pesan" title="Pesan"><i class="fa fa-commenting-o"></i></button>
