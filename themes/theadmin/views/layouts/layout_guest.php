  ...
  <header class="topbar topbar-expand-lg" id="topbar">
    <div class="container">
      <div class="topbar-left">
        <div class="m-1"><img src="<?= asset_path('/img/logo-hd-bsi.svg', '_theme_') ?>" alt="logo icon" style="width: 32px;"></div>
        <a class="text1">Helpdesk BSI.</a>
      </div>

      <div class="topbar-right">
        <form action="/login">
          <div type="submit" class="btn btn-sm btn-custom" onclick="window.location.href='<?= site_url('guest/Login'); ?>'"><i class="fa fa-sign-in"></i> login</div>
        </form>
      </div>
  ...
  <script>
    $(document).ready(function() {
      new Chart($("#chart-line-4"), {
        ...
        // Data
        data: {
          labels: ["2020-1", "2020-2", "2021-1", "2022-2", "2023-1", "2023-2", "2024-1", "2024-2", ],
          datasets: [{
              label: "Diterima",
              fill: false,
              borderWidth: 3,
